  ...
  return (
    <>
      <div className=" px-[140px] flex flex-col w-1/2 mt-[200px] place-content-end content-end ml-auto mr-7 ">
        ...
        {lang === "fn" && (
          <p className="text-[#faf5e9] text-[18px] leading-tight w-[370px] font-['Raleway'] font-semibold mt-2">
            Obtenez les produits dՎpicerie et les aliments les plus abordables
            sur le continent sans stress.
          </p>
        )}
        ...
        {lang === "fn" && (
          <button
            className="bg-[#009b4d] bg-opacity-60 drop-shadow-2xl w-[200px] border-[0.5px] border-black font-['Raleway'] text-[#ffffff] text-base font-semibold mt-6 rounded-full px-[20px] py-[9px] hover:bg-opacity-60 hover:border-none transition-transform "
            type="button"
          >
            Rejoindre un groupe
          </button>
